...
import { MonthlySummaryRowModel } from '../../../domain/models/trash-rate-report.model';
...
export class GetMonthlySummaryRowUseCase {
  ...
  async execute(
    ...
    const modelResult: MonthlySummaryRowModel[] =
      await this.trashRateReportRepository.getMonthlySummaryReport(
        startDate,
        endDate,
      );
